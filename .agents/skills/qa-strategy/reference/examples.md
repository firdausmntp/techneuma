# Qa Strategy Examples

Use this reference when invoking `qa-strategy` so the request quality is high and output is production-ready.
...
```text
Apply /qa-strategy to the checkout area.
Context: Design and review test strategy, release confidence, and defect prevention across unit, integration, end-to-end, exploratory, and operational quality checks.
...
```text
Use /qa-strategy for onboarding flow v2.
...
```text
Use /qa-strategy and make it look cool.
```
