...
Use this reference when invoking `internationalization` so the request quality is high and output is production-ready.
...
```text
Apply /internationalization to the checkout area.
Context: Expert i18n/l10n implementation with locale routing, translations, and cultural adaptation
...
```text
Use /internationalization for onboarding flow v2.
...
```text
Do /internationalization quickly.
```
...
```text
Use /internationalization and make it look cool.
```
