...
Use this reference when invoking `data-engineering` so the request quality is high and output is production-ready.
...
```text
Apply /data-engineering to the checkout area.
Context: Design and review analytical pipelines, data models, transformation jobs, and governance controls so data stays trustworthy, traceable, and useful under continuous change.
...
```text
Use /data-engineering for onboarding flow v2.
...
```text
Use /data-engineering and make it look cool.
```
