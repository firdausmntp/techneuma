...
Use this reference when invoking `extract` so the request quality is high and output is production-ready.
...
```text
Apply /extract to the checkout area.
Context: Extract and consolidate reusable components, design tokens, and patterns into your design system. Identifies opportunities for systematic reuse and enriches your component library.
...
```text
Use /extract for onboarding flow v2.
...
```text
Use /extract and make it look cool.
```
