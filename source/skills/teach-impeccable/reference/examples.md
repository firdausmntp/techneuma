# Teach Impeccable Examples

Use this reference when invoking `teach-impeccable` so the request quality is high and output is production-ready.
...
```text
Apply /teach-impeccable to the checkout area.
Context: One-time setup that gathers design context for your project and saves it to your AI config file. Run once to establish persistent design guidelines.
...
```text
Use /teach-impeccable for onboarding flow v2.
...
```text
Use /teach-impeccable and make it look cool.
```
